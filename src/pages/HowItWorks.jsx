    ...
    <div className="min-h-screen pb-28 bg-[#E8E8E8] fade-in-up overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                {/* Title */}
                <div className="mb-2 text-left w-full text-[#0D4183] group-hover:text-white font-poppins font-medium text-[20px] leading-none transition-colors duration-300">
                  {f.title}
                </div>
                {/* Description */}
                <div className="text-left text-sm text-[#0D4183] group-hover:text-white font-poppins font-normal leading-relaxed transition-colors duration-300">
                  {f.desc}
                </div>
              </div>
            ))}
      ...
      <div ref={addToRefs} className="mt-16 scroll-reveal">
        <div className="max-w-4xl mx-auto px-4 py-12 bg-white rounded-t-2xl rounded-bl-2xl shadow-xl">
          ...
          >
            Do you fulfill the eligibility criteria?{" "}
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-lg text-gray-700 px-4 md:px-8">
            ...
            <div className="flex items-start space-x-3">
              ...
              <span>
                 Credit score 450+ (
                <img src="/cibillogo.jpg" alt="Equifax Logo" style={{ height: "45px", display: "inline", marginLeft: "8px", marginRight: "1px" }} />
                <img src="/Equifaxlogo.png" alt="CIBIL Logo" style={{ height: "14px", display: "inline", marginLeft: "4px" }} />
                )
              </span>
