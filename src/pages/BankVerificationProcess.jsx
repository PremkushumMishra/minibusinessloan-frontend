...
function BankVerificationProcess() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 via-purple-100 to-blue-200 py-8 px-2">
      <div className="max-w-lg w-full mx-auto bg-white rounded-3xl shadow-2xl p-6 md:p-10 border border-gray-100">
        {/* Stepper/Progress */}
