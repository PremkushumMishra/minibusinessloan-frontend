...
const TERMS_CONTENT = (
  <div className="max-h-[60vh] overflow-y-auto px-2 py-4 bg-white border-l-8 border-[#E53935] rounded-xl shadow-lg text-black">
    <h2 className="text-2xl font-bold text-[#E53935] mb-4">Terms and Conditions</h2>
    <p className="text-[#E53935] font-bold mb-3">PLEASE READ THESE TERMS AND CONDITIONS ("TERMS") CAREFULLY. THESE TERMS CONSTITUTE A LEGALLY BINDING AGREEMENT BETWEEN YOU AND TECHAVIOM, A BRAND LEGALLY REGISTERED UNDER U.Y. FINCORP LIMITED ("THE COMPANY") IN JOINT VENTURE WITH FINTECH CLOUD PRIVATE LIMITED.</p>
    ...
    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">DEFINITIONS</h3>
    <ul className="list-disc pl-6 mb-3 space-y-1">
      <li>"Web Platform","Application" or "App" refers to "TechAvom," the web platform/ mobile software application developed and maintained by the Company to facilitate access to its Services.</li>
      ...
      <li>"Company" or "we" means TechAvom, a platform managed by U.Y. Fincorp Private Limited, incorporated under the Companies Act, 2013, and administered by its appointed representatives.</li>
      ...
      <li>"Website" refers to www.techaviom.com, the official web portal managed by the Company for rendering its Services.</li>
    </ul>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">DESCRIPTION OF SERVICES</h3>
    <p className="mb-2">The Platform enables eligible Customers to apply for credit facilities subject to verification and validation of requisite criteria. The Company, acting on behalf of the LENDER, may collect, verify, and assess User Data and related documents to process such applications.</p>
    ...
    <p className="mb-2">Data obtained from Central KYC Registry, UIDAI, or similar KYC verification systems is used strictly in accordance with the Prevention of Money Laundering Act, 2002 and RBI's KYC Master Directions, 2016. You hereby provide your informed and voluntary consent authorizing the Company and the LENDER to access, store, use, and process such information as required for regulatory or operational purposes.</p>
    <p className="mb-2">Loan disbursement shall be made through the method opted by the Customer on the Platform. Customers are obliged to repay all Outstanding Amounts to the LENDER on or before the stipulated due dates as reflected within the Application.</p>
    <p className="mb-2">The Company reserves the right to track the Customer's location during and after the use of the Services, including in cases where the Application is uninstalled or discontinued, until all financial obligations to the LENDER are fully discharged. Discontinuation of the Platform shall not absolve the Customer from repayment responsibilities.</p>
    <p className="mb-2">Customers are solely responsible for maintaining the confidentiality and security of their user credentials and for any activity conducted under their account. The Company disclaims all liability for loss, damages, or claims arising from unauthorized access or misuse of the Services. We reserve the right to accept or deny service requests at our sole discretion without obligation to provide reasoning.</p>
    <p className="mb-2">The performance of the Platform is contingent on the technical capabilities of the Customer's device and network connectivity. It is the Customer's responsibility to ensure that such devices and networks meet the minimum requirements for Service usage.</p>
    <p className="mb-2">The Company and its Lenders adhere to the RBI's Fair Practices Code and Digital Lending Guidelines, including disclosure of the Key Fact Statement (KFS), loan terms, interest rates, and recovery practices.</p>
    <p className="mb-2">By accepting these Terms, you authorize the Company to access, track, and process your Personal Information and User Data for identity authentication, creditworthiness evaluation, and operational continuity.</p>
    <p className="mb-2">These Terms govern platform usage and do not replace the Loan Agreement executed between the Customer and the Lender, which shall prevail in the event of any conflict between the two documents.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">CONSENT FOR COMMUNICATION</h3>
    <p className="mb-2">You hereby expressly consent to and authorize the Company, its representatives, affiliates, or LENDING/NBFC partners, including employees or agents, to contact you via phone calls, SMS, or other communication modes to share transaction-related updates, promotional offers, and product information.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">REGULATIONS</h3>
    <ul className="list-decimal pl-6 mb-3 space-y-1">
      <li>Engage in any fraudulent activities, embezzlement, money laundering, or unlawful conduct of any nature.</li>
      <li>Reproduce, duplicate, copy, sell, resell, or otherwise exploit any portion of the Platform without proper authorization.</li>
      <li>Upload, post, email, transmit, or make available any content that is unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, libelous, invasive of another's privacy, hateful, or otherwise objectionable based on race, ethnicity, or other discriminatory grounds.</li>
      ...
      <li>Forge headers or manipulate identifiers to obscure the origin of any content transmitted through the Platform.</li>
      <li>Upload, post, email, transmit, or otherwise make available any content that you do not have the legal right to disseminate under applicable laws or contractual or fiduciary obligations.</li>
      <li>Upload, post, email, transmit, or otherwise make available any content that infringes upon the intellectual property rights of any party.</li>
      ...
      <li>Upload, post, email, transmit, or otherwise make available any material containing software viruses or any other computer code, files, or programs designed to disrupt, damage, or limit the functionality of any computer software, hardware, or telecommunications equipment.</li>
      <li>Disrupt the normal flow of communication or otherwise act in a manner that negatively affects other users' ability to engage in real-time interactions.</li>
      <li>Interfere with or disrupt the operation of the Platform or servers or networks connected to the Platform.</li>
      <li>Intentionally or unintentionally violate any applicable local, state, national, or international laws, regulations, or ordinances with the force of law.</li>
    </ul>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">CONTENT AVAILABLE</h3>
    <p className="mb-2">You acknowledge that the Company makes no representations or warranties about the material, data, and information, such as data files, text, facts and figures, computer software, code, audio files or other sounds, photographs, videos, or other images (collectively, the "Content") which you may have access to as part of the Services, or through your use of the Platform. Under no circumstances, shall the Company be liable in any way for any Content, including, but not limited to any infringing Content, any errors or omissions in Content, or for any loss or damage of any kind incurred as a result of the use of any Content posted, transmitted, linked from, or otherwise accessible through or made available via the Platform. The Content on the Platform should not be regarded as an offer, solicitation, invitation, advice or recommendation to buy or sell investments, securities or any other instrument or financial products.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">PROPRIETARY RIGHTS OF THE COMPANY</h3>
    <p className="mb-2">You understand, acknowledge and agree that the Company is the sole owner of all rights, title and interest, including any and all intellectual property rights in the Content, Platform, Services, logos, trade names, brand names, designs and any necessary software used in connection with the Platform.</p>
    <p className="mb-2">There may be proprietary logos, service marks and trademarks found on the Platform whether owned/used by the Company or otherwise. By displaying them on the Platform, the Company is not granting you any license to utilize the proprietary logos, service marks, or trademarks. Any unauthorized use of the same may violate applicable intellectual property laws.</p>
    <p className="mb-2">You understand and acknowledge that the Platform is owned by the Company. Nothing under these Terms shall be deemed to be a transfer in ownership, rights, title, from the Company to you or any third party, in the Platform. You are entitled to avail the Services offered by the Company during the validity of your registration with the Company.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">USE OF THIRD-PARTY APIS/PLATFORMS</h3>
    <p className="mb-2">Our services may incorporate or rely on data obtained through third-party Application Programming Interfaces ("APIs"). These third-party APIs are used to enhance functionality and provide up-to-date information. By using our services, you acknowledge and agree that such data is subject to the availability, accuracy, and terms of service of the respective third- party providers. We do not guarantee the uninterrupted availability or accuracy of data sourced from these external APIs and shall not be held liable for any errors, omissions, or delays in the content provided by such third parties. The list of APIs/Platforms are as follows:</p>
    <ul className="list-disc pl-6 mb-3 space-y-1">
      <li>Surepass</li>
      <li>Novel Pattern</li>
      <li>Credgenics</li>
    ...
    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">TERMINATION</h3>
    ...
    <p className="mb-2">The Company reserves its right to Track you, even when you have uninstalled the App or even after termination of these Terms, until all your obligations, including but not limited to payment of the Outstanding Amount(s) is in subsistence.</p>
    <p className="mb-2">Upon termination of these Terms, the rights and licenses granted to you under these Terms shall cease to exist, and you must forthwith stop using the Platform and the Services and repay the Outstanding Amount(s). Notwithstanding anything contained in these Terms or otherwise, the termination of these Terms for any reason whatsoever, shall not affect your obligations, including but not limited to repayment of the Outstanding Amount(s).</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">INDEMNITY</h3>
    <p className="mb-2">You agree to indemnify and hold the Company, and its subsidiaries, affiliates, officers, agents, co-branders or other partners, and employees, harmless from any claim or demand, including attorneys' fees, made by any third party due to or arising out of (i) your violation of these Terms; (ii) your violation of any rights of other users of the Platform; (iii) your use or misuse of the Platform or the Services; (iv) your violation of applicable laws.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">LIMITATIONS OF LIABILITY</h3>
    <ul className="list-disc pl-6 mb-2">
    ...
    <p className="mb-2">You expressly understand and agree that the Company, including its directors, officers, employees, representatives or the service provider, shall not be liable for any direct, indirect, incidental, special, consequential or exemplary damages, including but not limited to, damages for loss of profits, goodwill, use, data or other intangible losses (even if the Company has been advised of the possibility of such damages), resulting from the above.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">FORCE MAJEURE</h3>
    <p className="mb-2">Notwithstanding anything to the contrary herein, the Company shall not be held liable for any loss, damage, or unavailability of the Platform or Services arising from any failure or deficiency in performance, whether in whole or in part, caused directly or indirectly by events, circumstances, or conditions beyond the reasonable control of the Company. Such events include, but are not limited to, acts of God, natural disasters, internet outages, failures of computer or telecommunication systems, changes in applicable laws or regulations (including those issued by the Reserve Bank of India), power outages, government actions, civil unrest, riots, or other force majeure events.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">YOUR RIGHTS</h3>
    <ul className="list-disc pl-6 mb-2">
      <li><b>Access and Update Your Personal Information:</b> You have the right to request access to the personal information we hold about you. This includes the right to view, verify, and request corrections or updates to ensure your information remains accurate and up to date.</li>
      <li><b>Withdraw Consent for Data Collection and Usage:</b> You may withdraw your consent for us to collect, use, or process your personal data at any time. Upon receiving such a request, we will cease processing your data unless we are legally required or permitted to retain it for specific purposes.</li>
      <li><b>Opt Out of Marketing Communications:</b> You have the right to opt out of receiving promotional or marketing communications from us at any time. This can typically be done by following the unsubscribe link provided in our emails or by contacting our support team directly. Please note that you may still receive important service-related communications even after opting out of marketing messages.</li>
    </ul>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">CHANGES TO TERMS</h3>
    <p className="mb-2">The Company reserves the right to modify, change, substitute, remove, suspend or update these Terms or any information thereof at any time by posting the updated Terms on the Platform. Such changes shall be effective immediately upon such posting. Continued use of the Services or the Platform, subsequent to making the changes, shall be deemed to be your acceptance of the revised Terms.</p>

    <h3 className="text-xl font-bold text-[#E53935] mt-6 mb-2">DISCLOSURE & CONTACT INFORMATION</h3>
    <p className="mb-2">Grievance Redressal Officer: Swati Aggarwal</p>
    <p className="mb-2">Contact Number: +91-7814447895</p>
    <p className="mb-2">Email ID: info@minibusinessloan.com</p>
    <p className="mb-2">Address: Lalita Park, Gurudwara, Lalita Park, New Delhi, East Delhi, Delhi, 110092</p>
    <p className="mb-2">Customer Support Hours: 09:00 AM to 05:30 PM (Monday to Saturday)</p>
  </div>
);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-transparent">
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full flex flex-col relative">
        ...
        <div className="px-8 pt-8 pb-4 flex-1 flex flex-col">
          <h2 className="text-2xl font-bold text-center text-gray-800 mb-4">Terms and Conditions</h2>
          <div className="overflow-y-auto max-h-[45vh] pr-2 text-gray-800" style={{ scrollbarWidth: 'thin' }}>
            {children}
          </div>
        </div>
        ...
        {!showOtpInput ? (
          ...
          <form className="mt-8 space-y-6" onSubmit={handleMobileSubmit}>
            ...
            <div className="mt-6 flex items-center">
              ...
              />
              <label htmlFor="consent" className="ml-2 block text-base select-none" style={{ color: '#b48b8b', fontWeight: 500 }}>
                I agree to the{' '}
                <button
                  type="button"
            ...
            <Modal open={showTermsModal} onClose={() => setShowTermsModal(false)} onAgree={() => { setHasConsented(true); setShowTermsModal(false); }}>
              {TERMS_CONTENT}
            </Modal>
